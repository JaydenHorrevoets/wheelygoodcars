    ...
    <div class="fullheight">
        <div class="card p-4" style="min-width: 50%;">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('register.do')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3 row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\wheelygoodcars\resources\views/auth/register.blade.php ENDPATH**/ ?>